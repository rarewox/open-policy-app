...
import { check_forgotten_email } from '../../../scripts/api/auth';
...
const GetForgottenEmail = () => {
  ...
  const handleNextButtonPress = async () => {
    try {
      ...
      const is_email = validateEmail(forgottenDetails);
      const response = await check_forgotten_email({
        is_email: is_email,
        email: forgottenDetails,
