...
import { forgot_password } from '../../../scripts/api/auth';

const ResetForgottenPassword = () => {
  const { forgotNewPassword, setForgotNewPassword, forgottenDetails } =
    useRegisterContext();
  ...
  const handleNext = async () => {
    if (
      ...
      try {
        ...
        router.push('/auth/forgot/complete');
      } catch (error) {
